;; Derived from boot.fileset, many thanks to Alan and Micha for their code and
;; help.

;; This file remains copy Alan Dipert and Micha Niskin, and is re-used here
;; under the terms of the Eclipse Public License.
(ns arachne.assets.fileset.impl
  (:require
    [arachne.assets.fileset.util :as util :refer [with-let debug warn]]
...
(defn- scratch-dir!
  [^File scratch]
  (util/tmpdir scratch "boot-scratch"))
